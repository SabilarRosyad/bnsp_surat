...
<div class="row">
    ...
    <div class="col-md-9">
        <h2 class="mt-4">Edit Kategori Surat</h2>
        @if ($errors->any())
        ...
        <form action="{{ route('categories.update', $category->id) }}" method="POST">
            ...
            <div class="mb-3 row items-center">
                <label class="col-sm-3 block text-sm font-medium text-gray-700 mb-1">ID (Auto Increment)</label>
                <div class="col-sm-9">
                    <input type="text" class="border rounded px-3 py-2 w-full bg-gray-100 text-gray-500" value="{{ $category->id }}" readonly>
                </div>
            </div>
            <div class="mb-3 row items-center">
                <label for="name" class="col-sm-3 block text-sm font-medium text-gray-700 mb-1">Nama Kategori</label>
                <div class="col-sm-9">
                    <input type="text" name="name" class="border rounded px-3 py-2 w-full focus:outline-none focus:ring focus:border-blue-300" value="{{ $category->name }}" required>
                </div>
            </div>
            <div class="mb-3 row items-center">
                <label for="description" class="col-sm-3 block text-sm font-medium text-gray-700 mb-1">Keterangan</label>
                <div class="col-sm-9">
                    <input type="text" name="description" class="border rounded px-3 py-2 w-full focus:outline-none focus:ring focus:border-blue-300" value="{{ $category->description }}">
                </div>
            </div>
